set moduleName dct_2d_Pipeline_Row_DCT_Loop_DCT_Outer_Loop
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dct_2d_Pipeline_Row_DCT_Loop_DCT_Outer_Loop}
...
set Spec2ImplPortList { 
	in_block { ap_memory {  { in_block_address0 mem_address 1 6 }  { in_block_ce0 mem_ce 1 1 }  { in_block_q0 in_data 0 16 }  { in_block_address1 MemPortADDR2 1 6 }  { in_block_ce1 MemPortCE2 1 1 }  { in_block_q1 MemPortDOUT2 0 16 }  { in_block_address2 MemPortADDR2 1 6 }  { in_block_ce2 MemPortCE2 1 1 }  { in_block_q2 MemPortDOUT2 0 16 }  { in_block_address3 MemPortADDR2 1 6 }  { in_block_ce3 MemPortCE2 1 1 }  { in_block_q3 in_data 0 16 }  { in_block_address4 MemPortADDR2 1 6 }  { in_block_ce4 MemPortCE2 1 1 }  { in_block_q4 MemPortDOUT2 0 16 }  { in_block_address5 MemPortADDR2 1 6 }  { in_block_ce5 MemPortCE2 1 1 }  { in_block_q5 in_data 0 16 }  { in_block_address6 MemPortADDR2 1 6 }  { in_block_ce6 MemPortCE2 1 1 }  { in_block_q6 in_data 0 16 }  { in_block_address7 MemPortADDR2 1 6 }  { in_block_ce7 MemPortCE2 1 1 }  { in_block_q7 MemPortDOUT2 0 16 } } }
