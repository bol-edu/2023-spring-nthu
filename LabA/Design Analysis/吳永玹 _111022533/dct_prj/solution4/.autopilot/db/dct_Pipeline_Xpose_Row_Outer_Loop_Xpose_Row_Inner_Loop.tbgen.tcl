...
set portList { 
	...
	{ row_outbuf_i_q0 sc_in sc_lv 16 signal 1 } 
...
set Spec2ImplPortList { 
	...
	row_outbuf_i { ap_memory {  { row_outbuf_i_address0 mem_address 1 6 }  { row_outbuf_i_ce0 mem_ce 1 1 }  { row_outbuf_i_q0 in_data 0 16 } } }
