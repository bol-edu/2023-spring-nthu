...
entity dct_dct_Pipeline_DCT_Inner_Loop is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of dct_dct_Pipeline_DCT_Inner_Loop is 
...
attribute shreg_extract : string;
    ...
    signal zext_ln21_4_fu_128_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal zext_ln21_3_fu_118_p1 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    add_ln20_fu_112_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_n_2) + unsigned(ap_const_lv4_1));
    add_ln21_fu_122_p2 <= std_logic_vector(unsigned(zext_ln21) + unsigned(zext_ln21_3_fu_118_p1));
    add_ln22_fu_133_p2 <= std_logic_vector(unsigned(zext_ln24) + unsigned(zext_ln21_3_fu_118_p1));
    ...
    ap_sig_allocacmp_n_2_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, n_fu_44)
    begin
    ...
    ap_sig_allocacmp_tmp_3_assign_proc : process(ap_enable_reg_pp0_iter4, ap_block_pp0_stage0, tmp_fu_40, grp_fu_169_p3)
    begin
    ...
    buf_2d_in_address0 <= zext_ln22_fu_139_p1(6 - 1 downto 0);
    ...
    dct_coeff_table_address0 <= zext_ln21_4_fu_128_p1(6 - 1 downto 0);
    ...
    icmp_ln20_fu_106_p2 <= "1" when (ap_sig_allocacmp_n_2 = ap_const_lv4_8) else "0";
    tmp_out <= ap_sig_allocacmp_tmp_3(29 - 1 downto 0);

    tmp_out_ap_vld_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln20_reg_192_pp0_iter2_reg)
    begin
    ...
    zext_ln21_3_fu_118_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_n_2),6));
    zext_ln21_4_fu_128_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln21_fu_122_p2),64));
