...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln21", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln21 sc_in sc_lv 6 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln21", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "zext_ln21", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln21 { ap_none {  { zext_ln21 in_data 0 6 } } }
