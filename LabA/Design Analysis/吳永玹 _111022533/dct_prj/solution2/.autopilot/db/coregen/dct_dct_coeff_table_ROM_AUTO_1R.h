...
// ==============================================================
#ifndef __dct_dct_coeff_table_ROM_AUTO_1R_H__
#define __dct_dct_coeff_table_ROM_AUTO_1R_H__
...
struct dct_dct_coeff_table_ROM_AUTO_1R_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dct_dct_coeff_table_ROM_AUTO_1R_ram) {
...
SC_MODULE(dct_dct_coeff_table_ROM_AUTO_1R) {
...
dct_dct_coeff_table_ROM_AUTO_1R_ram* meminst;


SC_CTOR(dct_dct_coeff_table_ROM_AUTO_1R) {
meminst = new dct_dct_coeff_table_ROM_AUTO_1R_ram("dct_dct_coeff_table_ROM_AUTO_1R_ram");
