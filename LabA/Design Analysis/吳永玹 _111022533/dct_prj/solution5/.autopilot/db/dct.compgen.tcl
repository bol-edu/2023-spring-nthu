...
set ID 65
set hasByteEnable 0
set MemName dct_buf_2d_in_RAM_AUTO_1R1W_memcore
...
set MemName dct_buf_2d_in_RAM_AUTO_1R1W
...
set ID 66
set hasByteEnable 0
set MemName dct_buf_2d_out_RAM_AUTO_1R1W_memcore
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 16
set AddrRange 64
...
set FullThresh 0
set CoreName ap_simcore_mem_df_channel
set MemName dct_buf_2d_out_RAM_AUTO_1R1W
if {${::AESL::PGuard_autocg_gen} || ${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mem_df_channel] == "ap_gen_simcore_mem_df_channel"} {
    eval "ap_gen_simcore_mem_df_channel { \
    id ${ID} \
