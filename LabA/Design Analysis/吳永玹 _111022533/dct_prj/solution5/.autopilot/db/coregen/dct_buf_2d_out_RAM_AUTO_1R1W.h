...
#ifndef _dct_buf_2d_out_RAM_AUTO_1R1W_H_
#define _dct_buf_2d_out_RAM_AUTO_1R1W_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "dct_buf_2d_out_RAM_AUTO_1R1W_memcore.h"

SC_MODULE(dct_buf_2d_out_RAM_AUTO_1R1W) {
...
protected:
    ...
    dct_buf_2d_out_RAM_AUTO_1R1W_memcore* dct_buf_2d_out_RAM_AUTO_1R1W_memcore_U;
...
public:
    ...
    SC_CTOR(dct_buf_2d_out_RAM_AUTO_1R1W) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        dct_buf_2d_out_RAM_AUTO_1R1W_memcore_U = new dct_buf_2d_out_RAM_AUTO_1R1W_memcore("dct_buf_2d_out_RAM_AUTO_1R1W_memcore_U");
        dct_buf_2d_out_RAM_AUTO_1R1W_memcore_U->clk      ( clk );
        dct_buf_2d_out_RAM_AUTO_1R1W_memcore_U->reset    ( reset );
        dct_buf_2d_out_RAM_AUTO_1R1W_memcore_U->ce0      ( i_ce0 );
        dct_buf_2d_out_RAM_AUTO_1R1W_memcore_U->we0      ( i_we0 );
        dct_buf_2d_out_RAM_AUTO_1R1W_memcore_U->address0 ( memcore_iaddr );
        dct_buf_2d_out_RAM_AUTO_1R1W_memcore_U->d0       ( i_d0 );
        dct_buf_2d_out_RAM_AUTO_1R1W_memcore_U->q0       ( i_q0 );

        dct_buf_2d_out_RAM_AUTO_1R1W_memcore_U->ce1      ( t_ce0 );
        dct_buf_2d_out_RAM_AUTO_1R1W_memcore_U->we1      ( t_we0 );
        dct_buf_2d_out_RAM_AUTO_1R1W_memcore_U->address1 ( memcore_taddr );
        dct_buf_2d_out_RAM_AUTO_1R1W_memcore_U->d1       ( t_d0 );
        dct_buf_2d_out_RAM_AUTO_1R1W_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "dct_buf_2d_out_RAM_AUTO_1R1W.trace");
            // ports
