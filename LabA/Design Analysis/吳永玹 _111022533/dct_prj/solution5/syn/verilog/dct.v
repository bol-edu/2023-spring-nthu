...
(* CORE_GENERATION_INFO="dct_dct,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=6.508000,HLS_SYN_LAT=577,HLS_SYN_TPT=443,HLS_SYN_MEM=3,HLS_SYN_DSP=0,HLS_SYN_FF=1208,HLS_SYN_LUT=1628,HLS_VERSION=2022_1}" *)
...
assign ap_idle = (write_data_U0_ap_idle & read_data_U0_ap_idle & (buf_2d_out_t_empty_n ^ 1'b1) & (buf_2d_in_7_t_empty_n ^ 1'b1) & (buf_2d_in_6_t_empty_n ^ 1'b1) & (buf_2d_in_5_t_empty_n ^ 1'b1) & (buf_2d_in_4_t_empty_n ^ 1'b1) & (buf_2d_in_3_t_empty_n ^ 1'b1) & (buf_2d_in_2_t_empty_n ^ 1'b1) & (buf_2d_in_1_t_empty_n ^ 1'b1) & (buf_2d_in_t_empty_n ^ 1'b1) & dct_2d_U0_ap_idle);
...
assign dct_2d_U0_ap_start = (buf_2d_in_t_empty_n & buf_2d_in_7_t_empty_n & buf_2d_in_6_t_empty_n & buf_2d_in_5_t_empty_n & buf_2d_in_4_t_empty_n & buf_2d_in_3_t_empty_n & buf_2d_in_2_t_empty_n & buf_2d_in_1_t_empty_n);
