...
architecture behav of dct is 
    ...
    "dct_dct,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=6.508000,HLS_SYN_LAT=577,HLS_SYN_TPT=443,HLS_SYN_MEM=3,HLS_SYN_DSP=0,HLS_SYN_FF=1208,HLS_SYN_LUT=1628,HLS_VERSION=2022_1}";
...
begin
    ...
    ap_done <= write_data_U0_ap_done;
    ap_idle <= (write_data_U0_ap_idle and read_data_U0_ap_idle and (buf_2d_out_t_empty_n xor ap_const_logic_1) and (buf_2d_in_7_t_empty_n xor ap_const_logic_1) and (buf_2d_in_6_t_empty_n xor ap_const_logic_1) and (buf_2d_in_5_t_empty_n xor ap_const_logic_1) and (buf_2d_in_4_t_empty_n xor ap_const_logic_1) and (buf_2d_in_3_t_empty_n xor ap_const_logic_1) and (buf_2d_in_2_t_empty_n xor ap_const_logic_1) and (buf_2d_in_1_t_empty_n xor ap_const_logic_1) and (buf_2d_in_t_empty_n xor ap_const_logic_1) and dct_2d_U0_ap_idle);
    ap_ready <= read_data_U0_ap_ready;
    ...
    dct_2d_U0_ap_start <= (buf_2d_in_t_empty_n and buf_2d_in_7_t_empty_n and buf_2d_in_6_t_empty_n and buf_2d_in_5_t_empty_n and buf_2d_in_4_t_empty_n and buf_2d_in_3_t_empty_n and buf_2d_in_2_t_empty_n and buf_2d_in_1_t_empty_n);
    input_r_address0 <= read_data_U0_input_r_address0;
