...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "output_r_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "9", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	output_r_c { ap_fifo {  { output_r_c_din fifo_port_we 1 64 }  { output_r_c_num_data_valid fifo_status_num_data_valid 0 5 }  { output_r_c_fifo_cap fifo_update 0 5 }  { output_r_c_full_n fifo_status 0 1 }  { output_r_c_write fifo_data 1 1 } } }
}
