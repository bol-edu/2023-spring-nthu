...
#define AUTOTB_TVIN_gmem "../tv/cdatafile/c.dct.autotvin_gmem.dat"
#define AUTOTB_TVOUT_gmem "../tv/cdatafile/c.dct.autotvout_gmem.dat"
...
#define AUTOTB_TVOUT_PC_gmem "../tv/rtldatafile/rtl.dct.autotvout_gmem.dat"
...
{
transaction<512> tr(4);
aesl_fh.read(AUTOTB_TVOUT_PC_gmem, tr.p, tr.tbytes);
if (little_endian()) { tr.reorder(); }
tr.send<64>((char*)__xlx_apatb_param_input_r, 2, 0);
tr.send<64>((char*)__xlx_apatb_param_output_r, 2, 2);
}
#else
try {
...
if (__xlx_apatb_param_input_r) {
  tr.import<64>((char*)__xlx_apatb_param_input_r, 2, 0);
}
__xlx_offset_byte_param_output_r = 2*64;
if (__xlx_apatb_param_output_r) {
  tr.import<64>((char*)__xlx_apatb_param_output_r, 2, 0);
}
