; ModuleID = 'D:/LAB/Interface_Synthesis/lab3/array_io_prj/solution9/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call void @copy_in([32 x i16]* nonnull %0, [16 x i16]* nonnull align 512 %d_o_copy_0, [16 x i16]* nonnull align 512 %d_o_copy_1, [32 x i16]* nonnull %1, [8 x i16]* nonnull align 512 %d_i_copy_0, [8 x i16]* nonnull align 512 %d_i_copy_1, [8 x i16]* nonnull align 512 %d_i_copy_2, [8 x i16]* nonnull align 512 %d_i_copy_3)
  ...
  call void @apatb_array_io_hw([16 x i16]* %d_o_copy_0, [16 x i16]* %d_o_copy_1, [8 x i16]* %d_i_copy_0, [8 x i16]* %d_i_copy_1, [8 x i16]* %d_i_copy_2, [8 x i16]* %d_i_copy_3)
  call void @copy_back([32 x i16]* %0, [16 x i16]* %d_o_copy_0, [16 x i16]* %d_o_copy_1, [32 x i16]* %1, [8 x i16]* %d_i_copy_0, [8 x i16]* %d_i_copy_1, [8 x i16]* %d_i_copy_2, [8 x i16]* %d_i_copy_3)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a32i16.5.6([8 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_0, [8 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_1, [8 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_2, [8 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_3, [32 x i16]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([32 x i16]* noalias readonly "orig.arg.no"="0", [16 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [16 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [32 x i16]* noalias readonly "orig.arg.no"="2", [8 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [8 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [8 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_2, [8 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_3) #4 {
entry:
  call void @onebyonecpy_hls.p0a32i16.3.4([16 x i16]* align 512 %_0, [16 x i16]* align 512 %_1, [32 x i16]* %0)
  call void @onebyonecpy_hls.p0a32i16.5.6([8 x i16]* align 512 %_01, [8 x i16]* align 512 %_12, [8 x i16]* align 512 %_2, [8 x i16]* align 512 %_3, [32 x i16]* %1)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a32i16.11.12([32 x i16]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [16 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [16 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a32i16.13.14([32 x i16]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [8 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [8 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [8 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_2, [8 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_3) #3 {
entry:
  %1 = icmp eq [32 x i16]* %0, null
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([32 x i16]* noalias "orig.arg.no"="0", [16 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [16 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [32 x i16]* noalias "orig.arg.no"="2", [8 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [8 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [8 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_2, [8 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_3) #5 {
entry:
  call void @onebyonecpy_hls.p0a32i16.11.12([32 x i16]* %0, [16 x i16]* align 512 %_0, [16 x i16]* align 512 %_1)
  call void @onebyonecpy_hls.p0a32i16.13.14([32 x i16]* %1, [8 x i16]* align 512 %_01, [8 x i16]* align 512 %_12, [8 x i16]* align 512 %_2, [8 x i16]* align 512 %_3)
  ret void
}

declare void @apatb_array_io_hw([16 x i16]*, [16 x i16]*, [8 x i16]*, [8 x i16]*, [8 x i16]*, [8 x i16]*)

; Function Attrs: argmemonly noinline norecurse
define internal void @copy_back([32 x i16]* noalias "orig.arg.no"="0", [16 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [16 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [32 x i16]* noalias "orig.arg.no"="2", [8 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [8 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [8 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_2, [8 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_3) #5 {
entry:
  call void @onebyonecpy_hls.p0a32i16.11.12([32 x i16]* %0, [16 x i16]* align 512 %_0, [16 x i16]* align 512 %_1)
  ret void
}

define void @array_io_hw_stub_wrapper([16 x i16]*, [16 x i16]*, [8 x i16]*, [8 x i16]*, [8 x i16]*, [8 x i16]*) #6 {
entry:
  %6 = alloca [32 x i16]
  %7 = alloca [32 x i16]
  call void @copy_out([32 x i16]* %6, [16 x i16]* %0, [16 x i16]* %1, [32 x i16]* %7, [8 x i16]* %2, [8 x i16]* %3, [8 x i16]* %4, [8 x i16]* %5)
  %8 = bitcast [32 x i16]* %6 to i16*
  %9 = bitcast [32 x i16]* %7 to i16*
  call void @array_io_hw_stub(i16* %8, i16* %9)
  call void @copy_in([32 x i16]* %6, [16 x i16]* %0, [16 x i16]* %1, [32 x i16]* %7, [8 x i16]* %2, [8 x i16]* %3, [8 x i16]* %4, [8 x i16]* %5)
  ret void
}
...
!7 = !DIFile(filename: "D:/LAB/Interface_Synthesis/lab3/array_io_prj/solution9/directives.tcl", directory: "D:\5CLAB\5CInterface_Synthesis\5Clab3")
...
!9 = !DIFile(filename: "array_io.c", directory: "D:\5CLAB\5CInterface_Synthesis\5Clab3")
!10 = !DISubroutineType(types: !11)
!11 = !{null, !12, !16}
!12 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !13, size: 64)
!13 = !DIDerivedType(tag: DW_TAG_typedef, name: "dout_t", file: !14, line: 52, baseType: !15)
!14 = !DIFile(filename: "./array_io.h", directory: "D:\5CLAB\5CInterface_Synthesis\5Clab3")
...
!19 = !DIFile(filename: "D:/LAB/Interface_Synthesis/lab3/array_io_prj/solution9/.autopilot/db\5Carray_io.pp.0.c", directory: "D:\5CLAB\5CInterface_Synthesis\5Clab3")
!20 = !{!21}
